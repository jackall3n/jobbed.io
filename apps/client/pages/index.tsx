...
function Container({ children, className }: React.PropsWithChildren<{ className?: string }>) {
  return (
    <div className={classnames("container mx-auto max-w-6xl", className)}>
      {children}
    </div>
  )
}
            ...
            <div className="w-full md:w-1/2 md:px-3">
              <div
                ...
                <p className="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">We help awesome
                  ...
                  IR35 preference to start receiving relevant opportunities.</p>
      ...
      <Container className="max-w-[600px] grid grid-cols-1 gap-8 py-10 px-5 xl:px-0">
        ...
        <div className="grid gap-8">
          ...
          {jobs.map(({ name, company, location, logo }, index) => (
            <div key={index}
                 className="bg-white rounded-xl p-5 hover:ring cursor-pointer transition-shadow ring-purple-500 ring-opacity-40">
              <div className="flex gap-3">
                ...
                <div className="flex-1 overflow-hidden">
                  ...
                  <div className="flex hidden">
                    <div
                      className="flex items-center text-xs px-1 py-0.5 text-yellow-800 mt-1 rounded-md bg-yellow-400">
                      <ChevronDoubleUpIcon className="w-3 h-3 mr-0.5" /> Promoted
                    </div>
                  </div>
                </div>
                <div className="flex-0 flex justify-center items-start">
              ...
              <div className="flex justify-between pt-5">
                ...
                <div className="flex items-center justify-center">
                  <div className="mr-5 text-sm whitespace-nowrap">
                    <span className="font-semibold">46</span> Applicants
                  </div>
